...
const adminNav = [
  ...
  { to: "/admin/advances", label: "Advances", icon: CreditCard },
];

const employeeNav = [
  { to: "/employee", label: "Dashboard", icon: Home, end: true },
  { to: "/employee/payslips", label: "My Payslips", icon: DollarSign },
  { to: "/employee/advances", label: "My Advances", icon: CreditCard },
];
    ...
    <div className="flex h-screen bg-gray-50">
      <aside className="w-56 bg-white shadow-sm flex flex-col">
        <div className="p-5 border-b">
          <p className="font-bold text-gray-800 text-sm">Payroll System</p>
